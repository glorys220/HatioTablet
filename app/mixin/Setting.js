Ext.define('Hatiopia.mixin.Setting', function() {
	var defaultSettings = [{
		id : 'autofit',
		value : false
	}, {
	...
	Ext.define('Hatiopia.mixin.Setting.Model', {
	...
	var store = Ext.create('Ext.data.Store', {
		model : 'Hatiopia.mixin.Setting.Model',
		// autoSync : true
	});
	...
	function setLocalSetting(name, value) {
		...
		var old;
		if(!record) {
			var set = Ext.create('Hatiopia.mixin.Setting.Model', {
				id : name,
				value : undefined
			});
			store.add(set);
	...
	Ext.define('Hatiopia.mixin.Setting.Inner', {
	...
	return {
		setting : Ext.create('Hatiopia.mixin.Setting.Inner')
	}
}());